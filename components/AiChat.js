...
export default function AiChat({ symbol, datos, interval = "15m", market = "crypto", onAnalysisChange }) {
    ...
    async function fetchModels() {
      try {
        ...
        setModels([
          ...
          { key: "nvidia-llama-70b", name: "Llama 3.3 70B", provider: "Meta", free: true },
          { key: "nvidia-nemotron-super", name: "Nemotron 3 Super 120B", provider: "NVIDIA", free: true },
          { key: "nvidia-nemotron-ultra", name: "Nemotron 3 Ultra 550B", provider: "NVIDIA", free: true },
  ...
  return (
    <div className="fixed top-4 right-0 bottom-4 z-50 flex flex-col w-full sm:w-[480px] max-w-[100vw] overflow-hidden"
      style={{
        background: "#080b11",
        ...
        height: panelHeight ? `calc(${panelHeight} - 32px)` : undefined,
      }}
    >
      {/* Scanline overlay */}
