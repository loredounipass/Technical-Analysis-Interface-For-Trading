...
# CALCULA LA SERIE MACD Y SU LINEA DE SE├æAL A PARTIR DE PRECIOS (USANDO EMA)
...
# CONSENSO DE SE├æALES (estilo TradingView) SOBRE OSCILADORES Y MEDIAS MOVILES
...
# STREAMING EN TIEMPO REAL DE BINANCE: actualiza la cach├® y emite a las salas
